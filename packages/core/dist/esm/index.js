...
import React31, { useEffect as useEffect7, useState as useState10 } from "react";
...
var useList = /* @__PURE__ */ __name(({
  ...
  const queryResponse = useQuery4({
    ...
    meta: {
      ...
      ...getXRay10("useList", preferLegacyKeys)
    }
  });
...
var useOne = /* @__PURE__ */ __name(({
  ...
  const queryResponse = useQuery5({
    ...
    meta: {
      ...queryOptions == null ? void 0 : queryOptions.meta,
      ...getXRay11("useOne", preferLegacyKeys)
    }
  });
  const { elapsedTime } = useLoadingOvertime({
    isLoading: queryResponse.isFetching,
...
var useMany = /* @__PURE__ */ __name(({
  ...
  const queryResponse = useQuery6({
    ...
    meta: {
      ...queryOptions == null ? void 0 : queryOptions.meta,
      ...getXRay12("useMany", preferLegacyKeys)
    }
  });
  const { elapsedTime } = useLoadingOvertime({
    isLoading: queryResponse.isFetching,
...
var UndoableQueueContextProvider = /* @__PURE__ */ __name(({ children }) => {
  ...
  return /* @__PURE__ */ React7.createElement(UndoableQueueContext.Provider, { value: notificationData }, children, typeof window !== "undefined" && notifications.map((notification) => /* @__PURE__ */ React7.createElement(
    UndoableQueue,
    {
...
var DataContext = React8.createContext(defaultDataProvider());
var DataContextProvider = /* @__PURE__ */ __name(({ children, ...rest }) => {
  ...
  return /* @__PURE__ */ React8.createElement(DataContext.Provider, { value: dataProviders }, children);
}, "DataContextProvider");
...
var useInfiniteList = /* @__PURE__ */ __name(({
  ...
  const queryResponse = useInfiniteQuery({
    ...
    meta: {
      ...queryOptions == null ? void 0 : queryOptions.meta,
      ...getXRay21("useInfiniteList", preferLegacyKeys)
    }
  });
  const { elapsedTime } = useLoadingOvertime({
    isLoading: queryResponse.isFetching,
...
var LiveContext = React9.createContext(void 0);
var LiveContextProvider = /* @__PURE__ */ __name(({
  liveProvider,
  children
}) => {
  return /* @__PURE__ */ React9.createElement(LiveContext.Provider, { value: liveProvider }, children);
}, "LiveContextProvider");
...
var ResourceContextProvider = /* @__PURE__ */ __name(({ resources: providedResources, children }) => {
  ...
  return /* @__PURE__ */ React11.createElement(ResourceContext.Provider, { value: { resources } }, children);
}, "ResourceContextProvider");

// src/contexts/router-picker/index.tsx
import React12 from "react";
var RouterPickerContext = React12.createContext("new");
var RouterPickerProvider = RouterPickerContext.Provider;
var useRouterType = /* @__PURE__ */ __name(() => {
  const value = React12.useContext(RouterPickerContext);
  return value;
}, "useRouterType");
...
import React13, { createContext } from "react";
var defaultBindings = {};
var RouterBindingsContext = createContext(defaultBindings);
var RouterBindingsProvider = /* @__PURE__ */ __name(({ children, router }) => {
  return /* @__PURE__ */ React13.createElement(RouterBindingsContext.Provider, { value: router ?? defaultBindings }, children);
}, "RouterBindingsProvider");

// src/hooks/router/use-parse/index.tsx
import React14, { useContext as useContext7 } from "react";
var useParse = /* @__PURE__ */ __name(() => {
  const bindings = useContext7(RouterBindingsContext);
  const useParse2 = React14.useMemo(
...
var useParsed = /* @__PURE__ */ __name(() => {
  ...
  const parsed = React15.useMemo(() => parse2(), [parse2]);
  return parsed;
}, "useParsed");
...
import { useContext as useContext9, useCallback as useCallback2 } from "react";
...
var useResourceSubscription = /* @__PURE__ */ __name(({
  ...
  const liveDataContext = useContext10(LiveContext);
  const {
...
var useSubscription = /* @__PURE__ */ __name(({
  ...
  const liveDataContext = useContext12(LiveContext);
  useEffect4(() => {
    let subscription;
    if (enabled) {
      subscription = liveDataContext == null ? void 0 : liveDataContext.subscribe({
...
var usePublish = /* @__PURE__ */ __name(() => {
  const liveContext = useContext13(LiveContext);
...
import React16, { createContext as createContext2 } from "react";
...
var TranslationContext = React17.createContext({});
...
var useSetLocale = /* @__PURE__ */ __name(() => {
  const { i18nProvider } = useContext16(TranslationContext);
...
var useTranslate = /* @__PURE__ */ __name(() => {
  const { i18nProvider } = useContext17(TranslationContext);
  const fn = useMemo2(() => {
...
import { useContext as useContext18, useCallback as useCallback6 } from "react";
var useGetLocale = /* @__PURE__ */ __name(() => {
  const { i18nProvider } = useContext18(TranslationContext);
...
var useForm = /* @__PURE__ */ __name(({
  ...
  const [id, setId] = React18.useState(defaultId);
  React18.useEffect(() => {
    setId(defaultId);
  }, [defaultId]);
...
import React20, { useCallback as useCallback8, useContext as useContext19 } from "react";
...
var useGo = /* @__PURE__ */ __name(() => {
  const bindings = useContext19(RouterBindingsContext);
  const { select: resourceSelect } = useResource();
  const getToPath = useGetToPath();
  const useGo2 = React20.useMemo(
...
import React21, { useContext as useContext20 } from "react";
var useBack = /* @__PURE__ */ __name(() => {
  const bindings = useContext20(RouterBindingsContext);
  const useBack2 = React21.useMemo(
...
import React22, { useState as useState5 } from "react";
...
var useShow = /* @__PURE__ */ __name(({
  ...
  const defaultId = getDefaultId();
  const [showId, setShowId] = useState5(defaultId);
  React22.useEffect(() => {
    setShowId(defaultId);
  }, [defaultId]);
  const combinedMeta = getMeta({
...
var useImport = /* @__PURE__ */ __name(({
  ...
  const [processedAmount, setProcessedAmount] = useState6(0);
  const [totalAmount, setTotalAmount] = useState6(0);
...
var useModal = /* @__PURE__ */ __name(({
  ...
  const [visible, setVisible] = useState7(defaultVisible);
...
import React23, { useContext as useContext21 } from "react";
var useLink = /* @__PURE__ */ __name(() => {
  const bindings = useContext21(RouterBindingsContext);
  if (bindings == null ? void 0 : bindings.Link) {
    return bindings.Link;
  }
  const FallbackLink = /* @__PURE__ */ __name(({ to, ...rest }) => /* @__PURE__ */ React23.createElement("a", { href: to, ...rest }), "FallbackLink");
  return FallbackLink;
}, "useLink");
...
var LegacyRouterContext = React24.createContext(defaultProvider);
...
var useRouterContext = /* @__PURE__ */ __name(() => {
  const routerContextValues = useContext22(RouterContext);
...
var AccessControlContext = React25.createContext({
  options: {
...
var useCan = /* @__PURE__ */ __name(({
  ...
  const queryResponse = useQuery8({
    ...
    meta: {
      ...
      ...getXRay22("useCan", preferLegacyKeys)
    },
    retry: false
  });
...
var useCanWithoutCache = /* @__PURE__ */ __name(() => {
  const { can: canFromContext } = React26.useContext(AccessControlContext);
  const can = React26.useMemo(() => {
    if (!canFromContext) {
      return void 0;
    }
...
var useSelect = /* @__PURE__ */ __name((props) => {
  ...
  const [selectedOptions, setSelectedOptions] = useState8([]);
  const {
    resource: resourceFromProps,
    sort,
    sorters,
  ...
  return {
    ...
    onSearch: debounce2(onSearch, debounceValue),
    overtime: { elapsedTime }
  };
}, "useSelect");
...
function useTable({
  ...
  const [sorters, setSorters] = useState9(
  ...
  const [current, setCurrent] = useState9(defaultCurrent);
  const [pageSize, setPageSize] = useState9(defaultPageSize);
...
var AuditLogContext = React28.createContext({});
var AuditLogContextProvider = /* @__PURE__ */ __name(({ create, get: get2, update, children }) => {
  return /* @__PURE__ */ React28.createElement(AuditLogContext.Provider, { value: { create, get: get2, update } }, children);
...
var useLogList = /* @__PURE__ */ __name(({
  ...
  const queryResponse = useQuery9({
    ...
    meta: {
      ...queryOptions == null ? void 0 : queryOptions.meta,
      ...getXRay24("useLogList", preferLegacyKeys)
    }
  });
...
var useMenu = /* @__PURE__ */ __name(({ meta, hideOnMissingParameter } = {
  ...
  const defaultOpenKeys = React30.useMemo(() => {
    if (!resource)
      return [];
    let parent = getParentResource(resource, resources);
  ...
  const prepareItem = React30.useCallback(
    (item) => {
      var _a, _b, _c, _d, _e, _f;
  ...
  const treeItems = React30.useMemo(() => {
...
var ErrorComponent = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ React31.createElement(React31.Fragment, null, /* @__PURE__ */ React31.createElement("h1", null, translate(
    "pages.error.404",
    void 0,
    "Sorry, the page you visited does not exist."
  )), errorMessage && /* @__PURE__ */ React31.createElement("p", null, errorMessage), /* @__PURE__ */ React31.createElement(
    "button",
    {
      onClick: () => {
        if (routerType === "legacy") {
...
var LoginPage = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ React32.createElement(React32.Fragment, null, /* @__PURE__ */ React32.createElement("h1", null, translate("pages.login.title", "Sign in your account")), /* @__PURE__ */ React32.createElement(
    "form",
    {
      onSubmit: (e) => {
        e.preventDefault();
    ...
    /* @__PURE__ */ React32.createElement("table", null, /* @__PURE__ */ React32.createElement("tbody", null, /* @__PURE__ */ React32.createElement("tr", null, /* @__PURE__ */ React32.createElement("td", null, translate("pages.login.username", void 0, "username"), ":"), /* @__PURE__ */ React32.createElement("td", null, /* @__PURE__ */ React32.createElement(
      "input",
      {
        type: "text",
        size: 20,
    ...
    ))), /* @__PURE__ */ React32.createElement("tr", null, /* @__PURE__ */ React32.createElement("td", null, translate("pages.login.password", void 0, "password"), ":"), /* @__PURE__ */ React32.createElement("td", null, /* @__PURE__ */ React32.createElement(
      "input",
      {
        type: "password",
        required: true,
    ...
    /* @__PURE__ */ React32.createElement("br", null),
    /* @__PURE__ */ React32.createElement("input", { type: "submit", value: "login" })
  ));
}, "LoginPage");
...
var LoginPage2 = /* @__PURE__ */ __name(({
  ...
  const [remember, setRemember] = useState12(false);
  const translate = useTranslate();
  const authProvider = useActiveAuthProvider();
  const { mutate: login } = useLogin({
    v3LegacyAuthProviderCompatible: Boolean(authProvider == null ? void 0 : authProvider.isLegacy)
  ...
  const renderLink = /* @__PURE__ */ __name((link, text2) => {
    return /* @__PURE__ */ React33.createElement(ActiveLink, { to: link }, text2);
  }, "renderLink");
  const renderProviders = /* @__PURE__ */ __name(() => {
    if (providers) {
      return providers.map((provider) => /* @__PURE__ */ React33.createElement(
        "div",
        {
          key: provider.name,
          style: {
        ...
        /* @__PURE__ */ React33.createElement(
          ...
          provider.label ?? /* @__PURE__ */ React33.createElement("label", null, provider.label)
        )
      ));
    }
    return null;
  }, "renderProviders");
  const content = /* @__PURE__ */ React33.createElement("div", { ...contentProps }, /* @__PURE__ */ React33.createElement("h1", { style: { textAlign: "center" } }, translate("pages.login.title", "Sign in to your account")), renderProviders(), !hideForm && /* @__PURE__ */ React33.createElement(React33.Fragment, null, /* @__PURE__ */ React33.createElement("hr", null), /* @__PURE__ */ React33.createElement(
    "form",
    {
      onSubmit: (e) => {
        e.preventDefault();
    ...
    /* @__PURE__ */ React33.createElement(
      ...
      /* @__PURE__ */ React33.createElement("label", { htmlFor: "email-input" }, translate("pages.login.fields.email", "Email")),
      /* @__PURE__ */ React33.createElement(
        "input",
        {
          id: "email-input",
      ...
      /* @__PURE__ */ React33.createElement("label", { htmlFor: "password-input" }, translate("pages.login.fields.password", "Password")),
      /* @__PURE__ */ React33.createElement(
        "input",
        {
          id: "password-input",
      ...
      rememberMe ?? /* @__PURE__ */ React33.createElement(React33.Fragment, null, /* @__PURE__ */ React33.createElement("label", { htmlFor: "remember-me-input" }, translate("pages.login.buttons.rememberMe", "Remember me"), /* @__PURE__ */ React33.createElement(
        "input",
        {
      ...
      registerLink ?? /* @__PURE__ */ React33.createElement("span", null, translate(
  ...
  )), registerLink !== false && hideForm && /* @__PURE__ */ React33.createElement("div", { style: { textAlign: "center" } }, translate("pages.login.buttons.noAccount", "Don\u2019t have an account?"), " ", renderLink(
    "/register",
    translate("pages.login.register", "Sign up")
  )));
...
var RegisterPage = /* @__PURE__ */ __name(({
  ...
  const renderLink = /* @__PURE__ */ __name((link, text2) => {
    return /* @__PURE__ */ React34.createElement(ActiveLink, { to: link }, text2);
  }, "renderLink");
  const renderProviders = /* @__PURE__ */ __name(() => {
    if (providers) {
      return providers.map((provider) => /* @__PURE__ */ React34.createElement(
        "div",
        {
          key: provider.name,
          style: {
        ...
        /* @__PURE__ */ React34.createElement(
          ...
          provider == null ? void 0 : provider.icon,
          provider.label ?? /* @__PURE__ */ React34.createElement("label", null, provider.label)
        )
      ));
    }
    return null;
  }, "renderProviders");
  const content = /* @__PURE__ */ React34.createElement("div", { ...contentProps }, /* @__PURE__ */ React34.createElement("h1", { style: { textAlign: "center" } }, translate("pages.register.title", "Sign up for your account")), renderProviders(), !hideForm && /* @__PURE__ */ React34.createElement(React34.Fragment, null, /* @__PURE__ */ React34.createElement("hr", null), /* @__PURE__ */ React34.createElement(
    "form",
    {
      onSubmit: (e) => {
        e.preventDefault();
    ...
    /* @__PURE__ */ React34.createElement(
      ...
      /* @__PURE__ */ React34.createElement("label", { htmlFor: "email-input" }, translate("pages.register.fields.email", "Email")),
      /* @__PURE__ */ React34.createElement(
        "input",
        {
          id: "email-input",
      ...
      /* @__PURE__ */ React34.createElement("label", { htmlFor: "password-input" }, translate("pages.register.fields.password", "Password")),
      /* @__PURE__ */ React34.createElement(
        "input",
        {
          id: "password-input",
      ...
      loginLink ?? /* @__PURE__ */ React34.createElement(React34.Fragment, null, /* @__PURE__ */ React34.createElement("span", null, translate(
  ...
  )), loginLink !== false && hideForm && /* @__PURE__ */ React34.createElement("div", { style: { textAlign: "center" } }, translate("pages.login.buttons.haveAccount", "Have an account?"), " ", renderLink("/login", translate("pages.login.signin", "Sign in"))));
...
import React35, { useState as useState14 } from "react";
var ForgotPasswordPage = /* @__PURE__ */ __name(({
  ...
  const renderLink = /* @__PURE__ */ __name((link, text2) => {
    return /* @__PURE__ */ React35.createElement(ActiveLink, { to: link }, text2);
  }, "renderLink");
  const content = /* @__PURE__ */ React35.createElement("div", { ...contentProps }, /* @__PURE__ */ React35.createElement("h1", { style: { textAlign: "center" } }, translate("pages.forgotPassword.title", "Forgot your password?")), /* @__PURE__ */ React35.createElement("hr", null), /* @__PURE__ */ React35.createElement(
    "form",
    {
      onSubmit: (e) => {
        e.preventDefault();
    ...
    /* @__PURE__ */ React35.createElement(
      ...
      /* @__PURE__ */ React35.createElement("label", { htmlFor: "email-input" }, translate("pages.forgotPassword.fields.email", "Email")),
      /* @__PURE__ */ React35.createElement(
        "input",
        {
          id: "email-input",
      ...
      /* @__PURE__ */ React35.createElement("br", null),
      loginLink ?? /* @__PURE__ */ React35.createElement("span", null, translate(
        "pages.register.buttons.haveAccount",
        "Have an account? "
      ), " ", renderLink("/login", translate("pages.login.signin", "Sign in")))
    )
  ));
  return /* @__PURE__ */ React35.createElement("div", { ...wrapperProps }, renderContent ? renderContent(content, title) : content);
}, "ForgotPasswordPage");
...
var UpdatePasswordPage = /* @__PURE__ */ __name(({
  ...
  const [newPassword, setNewPassword] = useState15("");
  const [confirmPassword, setConfirmPassword] = useState15("");
  const content = /* @__PURE__ */ React36.createElement("div", { ...contentProps }, /* @__PURE__ */ React36.createElement("h1", { style: { textAlign: "center" } }, translate("pages.updatePassword.title", "Update Password")), /* @__PURE__ */ React36.createElement("hr", null), /* @__PURE__ */ React36.createElement(
    "form",
    {
      onSubmit: (e) => {
        e.preventDefault();
    ...
    /* @__PURE__ */ React36.createElement(
      ...
      /* @__PURE__ */ React36.createElement("label", { htmlFor: "password-input" }, translate("pages.updatePassword.fields.password", "New Password")),
      /* @__PURE__ */ React36.createElement(
        "input",
        {
          id: "password-input",
      ...
      /* @__PURE__ */ React36.createElement("label", { htmlFor: "confirm-password-input" }, translate(
  ...
  return /* @__PURE__ */ React36.createElement("div", { ...wrapperProps }, renderContent ? renderContent(content, title) : content);
}, "UpdatePasswordPage");
...
var AuthPage = /* @__PURE__ */ __name((props) => {
  ...
  const renderView = /* @__PURE__ */ __name(() => {
    switch (type) {
      case "register":
        return /* @__PURE__ */ React37.createElement(RegisterPage, { ...props });
      case "forgotPassword":
        return /* @__PURE__ */ React37.createElement(ForgotPasswordPage, { ...props });
      case "updatePassword":
        return /* @__PURE__ */ React37.createElement(UpdatePasswordPage, { ...props });
      default:
        return /* @__PURE__ */ React37.createElement(LoginPage2, { ...props });
    }
  }, "renderView");
  return /* @__PURE__ */ React37.createElement(React37.Fragment, null, renderView());
}, "AuthPage");

// src/components/pages/ready/index.tsx
import React38 from "react";
var ReadyPage = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("h1", null, "Welcome on board"), /* @__PURE__ */ React38.createElement("p", null, "Your configuration is completed."), /* @__PURE__ */ React38.createElement("p", null, "Now you can get started by adding your resources to the", " ", /* @__PURE__ */ React38.createElement("code", null, "`resources`"), " property of ", /* @__PURE__ */ React38.createElement("code", null, "`<Refine>`")), /* @__PURE__ */ React38.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React38.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, /* @__PURE__ */ React38.createElement("button", null, "Documentation")), /* @__PURE__ */ React38.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, /* @__PURE__ */ React38.createElement("button", null, "Examples")), /* @__PURE__ */ React38.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, /* @__PURE__ */ React38.createElement("button", null, "Community"))));
}, "ReadyPage");
...
import React39, { useState as useState16 } from "react";
var cards = [
  {
    title: "Documentation",
...
var ConfigSuccessPage = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ React39.createElement(
    ...
    /* @__PURE__ */ React39.createElement(
      ...
      /* @__PURE__ */ React39.createElement("div", { style: { height: isMobile ? "40px" : "80px" } }),
      /* @__PURE__ */ React39.createElement("div", { style: { display: "flex", justifyContent: "center" } }, /* @__PURE__ */ React39.createElement(
        "div",
        {
          style: {
            backgroundRepeat: "no-repeat",
      ...
      /* @__PURE__ */ React39.createElement("div", { style: { height: "64px" } }),
      /* @__PURE__ */ React39.createElement(
        "div",
        {
          style: {
        ...
        cards.map((card) => /* @__PURE__ */ React39.createElement(Card, { key: `welcome-page-${card.title}`, card }))
      )
    )
  );
}, "ConfigSuccessPage");
var Card = /* @__PURE__ */ __name(({ card }) => {
  ...
  const [isHover, setIsHover] = useState16(false);
  return /* @__PURE__ */ React39.createElement(
    "div",
    {
      style: {
      ...
      /* @__PURE__ */ React40.createElement(
        ...
        /* @__PURE__ */ React40.createElement(
          ...
          /* @__PURE__ */ React40.createElement(
            ...
            /* @__PURE__ */ React40.createElement(ErrorIcon, null),
            /* @__PURE__ */ React40.createElement(
              "span",
              {
                style: {
        ...
        /* @__PURE__ */ React40.createElement(
          ...
          /* @__PURE__ */ React40.createElement("div", null, /* @__PURE__ */ React40.createElement(ExampleImplementation, null))
        )
      )
    )
  );
...
var ExampleImplementation = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ React40.createElement(
    ...
    /* @__PURE__ */ React40.createElement("span", { style: { color: "#FF7B72" } }, "import"),
    " ",
    "{",
    " Refine, WelcomePage",
    " ",
    "}",
    " ",
    /* @__PURE__ */ React40.createElement("span", { style: { color: "#FF7B72" } }, "from"),
    " ",
    /* @__PURE__ */ React40.createElement("span", { style: { color: "#A5D6FF" } }, '"@refinedev/core"'),
    ";",
    "\n",
    "\n",
    /* @__PURE__ */ React40.createElement("span", { style: { color: "#FF7B72" } }, "export"),
    " ",
    /* @__PURE__ */ React40.createElement("span", { style: { color: "#FF7B72" } }, "default"),
    " ",
    /* @__PURE__ */ React40.createElement("span", null, /* @__PURE__ */ React40.createElement("span", { style: { color: "#FF7B72" } }, "function"), " ", /* @__PURE__ */ React40.createElement("span", { style: { color: "#FFA657" } }, "App"), "(", /* @__PURE__ */ React40.createElement("span", { style: { color: "rgb(222, 147, 95)" } }), ")", " "),
    "{",
    "\n",
    "  ",
    /* @__PURE__ */ React40.createElement("span", { style: { color: "#FF7B72" } }, "return"),
    " (",
    "\n",
    "    ",
    /* @__PURE__ */ React40.createElement("span", null, /* @__PURE__ */ React40.createElement("span", { style: { color: "#79C0FF" } }, "<", /* @__PURE__ */ React40.createElement("span", { style: { color: "#79C0FF" } }, "Refine"), "\n", "      ", /* @__PURE__ */ React40.createElement("span", { style: { color: "#E5ECF2", opacity: 0.6 } }, "// ", /* @__PURE__ */ React40.createElement("span", null, "...")), "\n", "    ", ">"), "\n", "      ", /* @__PURE__ */ React40.createElement("span", { style: { opacity: 0.6 } }, "{", "/* ... */", "}"), "\n", "      ", /* @__PURE__ */ React40.createElement("span", { style: { color: "#79C0FF" } }, "<", /* @__PURE__ */ React40.createElement("span", { style: { color: "#79C0FF" } }, "WelcomePage"), " />"), "\n", "      ", /* @__PURE__ */ React40.createElement("span", { style: { opacity: 0.6 } }, "{", "/* ... */", "}"), "\n", "    ", /* @__PURE__ */ React40.createElement("span", { style: { color: "#79C0FF" } }, "</", /* @__PURE__ */ React40.createElement("span", { style: { color: "#79C0FF" } }, "Refine"), ">")),
    "\n",
    "  ",
    ");",
    "\n",
...
var ErrorGradient = /* @__PURE__ */ __name((props) => /* @__PURE__ */ React40.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 204,
  ...
  /* @__PURE__ */ React40.createElement("path", { fill: "url(#welcome-page-error-gradient-a)", d: "M12 0H0v12L12 0Z" }),
  /* @__PURE__ */ React40.createElement(
    "path",
    {
  ...
  /* @__PURE__ */ React40.createElement("defs", null, /* @__PURE__ */ React40.createElement(
    ...
    /* @__PURE__ */ React40.createElement("stop", { stopColor: "#FF4C4D", stopOpacity: 0.1 }),
    /* @__PURE__ */ React40.createElement("stop", { offset: 1, stopColor: "#FF4C4D", stopOpacity: 0 })
  ), /* @__PURE__ */ React40.createElement(
    "radialGradient",
    {
...
var ErrorIcon = /* @__PURE__ */ __name((props) => /* @__PURE__ */ React40.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 16,
...
var WelcomePage = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ React41.createElement(React41.Fragment, null, /* @__PURE__ */ React41.createElement(ConfigSuccessPage, null), !__initialized && /* @__PURE__ */ React41.createElement(ConfigErrorPage, null));
}, "WelcomePage");
...
var Telemetry = /* @__PURE__ */ __name(() => {
  ...
  const sent = React42.useRef(false);
  React42.useEffect(() => {
    if (sent.current) {
      return;
    }
...
var useRouterMisuseWarning = /* @__PURE__ */ __name((value) => {
  const warned = React43.useRef(false);
  React43.useEffect(() => {
...
var Refine = /* @__PURE__ */ __name(({
  ...
  const useNotificationProviderValues = React44.useMemo(() => {
  ...
  if (legacyRouterProvider && !routerProvider && (resources ?? []).length === 0) {
    return ReadyPage2 ? /* @__PURE__ */ React44.createElement(ReadyPage2, null) : /* @__PURE__ */ React44.createElement(ReadyPage, null);
  }
  const { RouterComponent = React44.Fragment } = !routerProvider ? legacyRouterProvider ?? {} : {};
  return /* @__PURE__ */ React44.createElement(QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React44.createElement(NotificationContextProvider, { ...notificationProviderContextValues }, /* @__PURE__ */ React44.createElement(
    LegacyAuthContextProvider,
    {
      ...legacyAuthProvider ?? {},
    ...
    /* @__PURE__ */ React44.createElement(
      ...
      /* @__PURE__ */ React44.createElement(DataContextProvider, { ...dataProvider }, /* @__PURE__ */ React44.createElement(LiveContextProvider, { liveProvider }, /* @__PURE__ */ React44.createElement(
        RouterPickerProvider,
        {
          value: legacyRouterProvider && !routerProvider ? "legacy" : "new"
        },
        /* @__PURE__ */ React44.createElement(RouterBindingsProvider, { router: routerProvider }, /* @__PURE__ */ React44.createElement(LegacyRouterContextProvider, { ...legacyRouterProvider }, /* @__PURE__ */ React44.createElement(ResourceContextProvider, { resources: resources ?? [] }, /* @__PURE__ */ React44.createElement(TranslationContextProvider, { i18nProvider }, /* @__PURE__ */ React44.createElement(
          AccessControlContextProvider,
          {
            ...accessControlProvider ?? {}
          },
          /* @__PURE__ */ React44.createElement(
            ...
            /* @__PURE__ */ React44.createElement(UndoableQueueContextProvider, null, /* @__PURE__ */ React44.createElement(
              RefineContextProvider,
              {
              ...
              /* @__PURE__ */ React44.createElement(UnsavedWarnContextProvider, null, /* @__PURE__ */ React44.createElement(RouterComponent, null, children, !disableTelemetryWithDefault && /* @__PURE__ */ React44.createElement(Telemetry, null), /* @__PURE__ */ React44.createElement(RouteChangeHandler, null)))
            ))
          )
        )))))
      )))
...
var UndoableQueue = /* @__PURE__ */ __name(({ notification }) => {
  ...
  const { notificationDispatch } = useCancelNotification();
  const { open } = useNotification();
  const [timeoutId, setTimeoutId] = useState17();
...
import React46, { useEffect as useEffect9 } from "react";
var LayoutWrapper = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ React46.createElement(
    ...
    children,
    /* @__PURE__ */ React46.createElement(UnsavedPrompt, null)
  );
}, "LayoutWrapper");
...
function Authenticated({
  ...
  if (!hasAuthProvider) {
    return /* @__PURE__ */ React47.createElement(React47.Fragment, null, children ?? null);
  }
  if (isFetching) {
    return /* @__PURE__ */ React47.createElement(React47.Fragment, null, loadingContent ?? null);
  }
  if (isAuthenticated) {
    return /* @__PURE__ */ React47.createElement(React47.Fragment, null, children ?? null);
  }
  if (typeof fallbackContent !== "undefined") {
    return /* @__PURE__ */ React47.createElement(React47.Fragment, null, fallbackContent ?? null);
  }
  ...
  if (appliedRedirect) {
    if (isLegacyRouter) {
      ...
      return /* @__PURE__ */ React47.createElement(RedirectLegacy, { to: `${appliedRedirect}${toQuery}` });
    }
...
import React48, { useEffect as useEffect11 } from "react";
var CanAccess = /* @__PURE__ */ __name(({
  ...
  if (data == null ? void 0 : data.can) {
    if (React48.isValidElement(children)) {
      const Children = React48.cloneElement(children, rest);
      return Children;
    }
    return /* @__PURE__ */ React48.createElement(React48.Fragment, null, children);
  }
  if ((data == null ? void 0 : data.can) === false) {
    return /* @__PURE__ */ React48.createElement(React48.Fragment, null, fallback ?? null);
  }
  return null;
}, "CanAccess");

// src/components/gh-banner/index.tsx
import React49, { useEffect as useEffect12 } from "react";
...
var GitHubBanner = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ React49.createElement(
    ...
    /* @__PURE__ */ React49.createElement(
      ...
      /* @__PURE__ */ React49.createElement(Text, { text })
    )
  );
}, "GitHubBanner");
...
var GlowSmall = /* @__PURE__ */ __name(({ style, ...props }) => {
  return /* @__PURE__ */ React49.createElement(
    ...
    /* @__PURE__ */ React49.createElement("circle", { cx: 40, r: 40, fill: `url(#${props.id}-a)`, fillOpacity: 0.5 }),
    /* @__PURE__ */ React49.createElement("defs", null, /* @__PURE__ */ React49.createElement(
      "radialGradient",
      {
        id: `${props.id}-a`,
        cx: 0,
      ...
      /* @__PURE__ */ React49.createElement("stop", { stopColor: "#47EBEB" }),
      /* @__PURE__ */ React49.createElement("stop", { offset: 1, stopColor: "#47EBEB", stopOpacity: 0 })
    ))
  );
}, "GlowSmall");
var GlowBig = /* @__PURE__ */ __name(({ style, ...props }) => /* @__PURE__ */ React49.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 120,
...
var AutoSaveIndicator = /* @__PURE__ */ __name(({
  status,
  elements: {
    success = /* @__PURE__ */ React50.createElement(Message, { key: "autoSave.success", defaultMessage: "saved" }),
    error = /* @__PURE__ */ React50.createElement(Message, { key: "autoSave.error", defaultMessage: "auto save failure" }),
    loading = /* @__PURE__ */ React50.createElement(Message, { key: "autoSave.loading", defaultMessage: "saving..." }),
    idle = /* @__PURE__ */ React50.createElement(Message, { key: "autoSave.idle", defaultMessage: "waiting for changes" })
  } = {}
}) => {
  switch (status) {
    case "success":
      return /* @__PURE__ */ React50.createElement(React50.Fragment, null, success);
    case "error":
      return /* @__PURE__ */ React50.createElement(React50.Fragment, null, error);
    case "loading":
      return /* @__PURE__ */ React50.createElement(React50.Fragment, null, loading);
    default:
      return /* @__PURE__ */ React50.createElement(React50.Fragment, null, idle);
  }
}, "AutoSaveIndicator");
var Message = /* @__PURE__ */ __name(({
  ...
  const translate = useTranslate();
  return /* @__PURE__ */ React50.createElement("span", null, translate(key, defaultMessage));
}, "Message");
export {
